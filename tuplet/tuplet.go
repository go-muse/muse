...
func (t Tuplet) IsSet() bool { return t.m != 0 && t.n != 0 }
...
// Equal reports whether two tuplets are exactly equal,
// comparing both m and n values.
func (t Tuplet) Equal(other Tuplet) bool {
	return t.m == other.m && t.n == other.n
}
