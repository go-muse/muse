...
**Note** is the representation of a musical sound. It's name represent a pitch class. **Note value** is the duration relative to the bar, **note duration** is the duration in time units.
...
**Interval** is the ratio of two musical sounds in pitch. **Chromatic interval** means the ratio of two notes, **diatonic interval** means the ratio of two degrees.
...
A: You need to create interval from that notes. [![example](https://img.shields.io/badge/example-link-blue)](https://pkg.go.dev/github.com/go-muse/muse/interval#example-NewChromatic)

Q: How to know interval by two degrees?\
A: You need to create interval from that degrees. [![example](https://img.shields.io/badge/example-link-blue)](https://pkg.go.dev/github.com/go-muse/muse/interval#example-NewDiatonic)
...
A: You can iterate through degrees  [![example](https://img.shields.io/badge/example-link1-blue)](https://pkg.go.dev/github.com/go-muse/muse/mode#example-Mode.IterateOneRound) [![example](https://img.shields.io/badge/example-link2-blue)](https://pkg.go.dev/github.com/go-muse/muse/degree#example-Iterator.GetAllDegrees) or notes [![example](https://img.shields.io/badge/example-link-blue)](https://pkg.go.dev/github.com/go-muse/muse/degree#example-Iterator.GetAllNotes) of modes.

Q: Are there already existing scales in the library?\
A: Yes, there is mode templates store [![example](https://img.shields.io/badge/example-link-blue)](https://pkg.go.dev/github.com/go-muse/muse/mode#example-InitTemplatesStore). It contains mode names and templates.
