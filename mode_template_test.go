...
func TestRearrangeFromDegree(t *testing.T) {
	modeTemplate := ModeTemplate{1, 2, 3, 4, 5}
...
func TestGetHalftonesByDegreeNum(t *testing.T) {
	...
	assert.Equal(t, HalfTones(6), result)
}

// TODO: make more intellectual test.
func TestIterateModeTemplateOneRound(t *testing.T) {
	modeTemplate := ModeTemplate{1, 2, 3, 4, 5}
	var halfTonesFromPrimeExpected HalfTones
	degreeNumExpected := DegreeNum(1)
...
func TestModeTemplateIterateOneRound(t *testing.T) {
	m := ModeTemplate{2, 2, 1, 2, 2, 2, 1}

	c := m.IterateOneRound(false)
	var expected []ModeTemplateIteratorResult

	expected = []ModeTemplateIteratorResult{
		func() (DegreeNum, HalfTones, HalfTones) { return 2, 2, 2 },
		func() (DegreeNum, HalfTones, HalfTones) { return 3, 2, 4 },
		func() (DegreeNum, HalfTones, HalfTones) { return 4, 1, 5 },
		func() (DegreeNum, HalfTones, HalfTones) { return 5, 2, 7 },
		func() (DegreeNum, HalfTones, HalfTones) { return 6, 2, 9 },
		func() (DegreeNum, HalfTones, HalfTones) { return 7, 2, 11 },
	}

	var res ModeTemplateIteratorResult
	var expDegreenum, resDegreenum DegreeNum
	var expHalfTones, resHalfTones, expHalfTonesFromPrime, resHalfTonesFromPrime HalfTones
	...
	expected = []ModeTemplateIteratorResult{
		...
		func() (DegreeNum, HalfTones, HalfTones) { return 6, 2, 9 },
		func() (DegreeNum, HalfTones, HalfTones) { return 7, 2, 11 },
		func() (DegreeNum, HalfTones, HalfTones) { return 8, 1, 12 },
	}
